...
const Contact = () => {
  return (
    <div
      name="contato"
      className="w-full  bg-gradient-to-b from-gray-800 to-purple-800 p-4 text-white"
    >
      <div className=" flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full relative top-56">
